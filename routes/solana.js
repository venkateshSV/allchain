...
class Sol{
    constructor()
    {
        console.log("You are connected to Solana chain.")
    }
    ...
    static async getGasPrice()
    {
        ...
        transaction.feePayer = this.getPubkey();
    ...
    {
        if(amount+this.getGasPrice()>this.getBalance())
        {
            ...
            console.log(`Available Balance of the sender before the transaction ${await this.getBalance()} SOL.`);
            console.log(`Gas fees for the transaction ${await this.getGasPrice()} SOL.`)
            console.log('Transaction completed successfully.');
            console.log(`Available Balance of the sender after the transaction ${await this.getBalance()} SOL.`);
        }
        
    }
    static async getTransaction(pubkey)
    {
